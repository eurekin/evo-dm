...
//	------------------------------------------------------------------------------
	public Evaluation(float P, float R, float Fsc, float Acc){
			...
			if (Configuration.getConfiguration().isFsc()) this.Fitness = Fsc;
			else this.Fitness = Acc;
...
//	------------------------------------------------------------------------------	
	public void update(final Evaluation E){
		...
		if (Configuration.getConfiguration().isFsc()) this.Fitness = this.Fitness + E.Fsc;
		else this.Fitness = this.Fitness + E.Accuracy;
...
//	------------------------------------------------------------------------------
	public void doAverage(int classes){
		...
		if (Configuration.getConfiguration().isFsc()) this.Fitness = this.Fsc / classes;
		else this.Fitness = this.Accuracy /  classes;
