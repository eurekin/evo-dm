...
public class Condition {
   ...
   private RelationType relation;
    ...
    public Condition(int atribID, RelationType r, float value1, float value2) throws Exception{
        ...
        if (atribID<0 || atribID>Configuration.getConfiguration().getNumberOfAttributes()) throw new Exception("Illegal attributes number! "+Integer.toString(atribID)+" ?");
        this.atribID = atribID;
        this.relation = r;
        if (value1<0.0f || value1>1.0f || value2<0.0f || value2>1.0f ) throw new Exception("Illegal types! ?"+Float.toString(value1)+" ?"+Float.toString(value1));
    ...
    public String toString(){
         ...
         if (this.atribID==-1) s.append( relation +"<" +String.format("%.3f",value1) +";"+ String.format("%.3f",value2) +">" );
         else s.append(""+Integer.toString( this.atribID )+" "+ relation +"<" + String.format("%.3f",value1) +";"+ String.format("%.3f",value2) +">" );
         return s.toString();
    }
}
